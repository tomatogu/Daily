...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  devServer: {
    before(app) {
      ...
      app.get('/api/newsDetail', function(req, res) {
      ...
      app.get('/api/themesList', function(req, res) {
      ...
      app.get('/api/psychology', function(req, res) {
        const id = req.query.id
      ...
      app.get('/api/not-boring', function(req, res) {
        const id = req.query.id
        const url = `https://news-at.zhihu.com/api/4/theme/${id}`
